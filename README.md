...
* **Égaliseur :** Accès direct à l'égaliseur audio du système.
...
* **Recherche globale :** Recherche rapide de morceaux ou d'artistes sur la plateforme Audius.
...
* **Gestion intelligente des jaquettes :** Résolution optimale de jaquette préférée (480x480) et fallback automatique sur les serveurs miroirs d'Audius en cas d'indisponibilité d'un hôte.

---

## Stack Technique

| Composant | Technologie | Version / Configuration |
| :--- | :--- | :--- |
...
| **Compatibilité** | Min SDK: `API 24` (Android 7.0) | Target SDK: `API 36` (Android 16) |
